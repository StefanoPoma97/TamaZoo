...
public class Tamagotchi 
{
	...
	{
		if (sonoMorto()==true)
			return String.format("Tamagotchi: %s %n Grado affettività: %.1f %n Grado sazietà: %.1f %n IL TAMAGOTCHI E' MORTO ",nome,grado_affettivita, grado_sazieta);

		else if (sonoTriste()==true)
			return String.format("Tamagotchi: %s %n Grado affettività: %.1f %n Grado sazietà: %.1f %n %n Grado soddisfazione: %.1f %n IL TAMAGOTCHI E' TRISTE ",nome,grado_affettivita, grado_sazieta,grado_soddisfazione);

		else
			return String.format("Tamagotchi: %s %n Grado affettività: %.1f %n Grado sazietà: %.1f %n Grado soddisfazione: %.1f",nome,grado_affettivita, grado_sazieta,grado_soddisfazione);
	}
